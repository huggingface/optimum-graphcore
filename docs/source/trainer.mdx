...
Most of the examples in the `/examples` directory use `IPUTrainer` as do most of the Jupyter notebooks in the `/notebooks` directory.
...
[[autodoc]] IPUSeq2SeqTrainer API reference
  - evaluate
  - predict


### IPUTrainingArguments API reference
