...
from transformers.generation_utils import GenerationMixin, GreedySearchEncoderDecoderOutput, GreedySearchDecoderOnlyOutput
from transformers.generation_utils import LogitsProcessorList, StoppingCriteriaList, StoppingCriteria, GreedySearchOutput
from transformers.generation_utils import BeamSearchOutput, BeamScorer, BeamSearchDecoderOnlyOutput, BeamSearchEncoderDecoderOutput
from transformers.generation_utils import SampleDecoderOnlyOutput, SampleEncoderDecoderOutput, SampleOutput
...
class IPUGenerationMixin(GenerationMixin):
    ...
    def _call_generate(self, *args, **kwargs):
        def check_kwarg_equality(dict1, dict2):
        ...
        # else:
        #     # Recompile if kwargs have changed
        #     if not check_kwarg_equality(self.cached_kwargs, kwargs):
        #         self.poptorch_model.destroy()
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if model_kwargs["past"] is not None:
                model_kwargs["past"] = self._reorder_cache(model_kwargs["past"], beam_idx)
=======
>>>>>>> Greedy search and Beam search both working for GPT2 and BART
...
# class IPUGenerationMixinOld(GenerationMixin):
#     """
