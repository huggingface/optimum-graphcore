...
def get_options(config):
    ...
    opts.Training.gradientAccumulation(config.gradient_accumulation_steps)
...
def parse_bert_args(args=None):
    ...
    pparser.add_argument("--config", type=str, help="Configuration Name", default="demo_tiny_128")
    ...
    if args.use_popdist:
        args.global_batch_size = (
            args.replication_factor * args.gradient_accumulation * args.batch_size * args.popdist_size
        )
    else:
        args.global_batch_size = args.replication_factor * args.gradient_accumulation * args.batch_size

    args.samples_per_step = (
        args.replication_factor * args.gradient_accumulation * args.batch_size * args.batches_per_step
    )
