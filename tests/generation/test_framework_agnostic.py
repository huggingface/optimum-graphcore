...
Adapted from: https://github.com/huggingface/transformers/blob/main/tests/generation/test_framework_agnostic.py
"""
...
class GenerationIntegrationTestsMixin:
    ...
    default_ipu_config: IPUConfig = None
    parallelize_model: Callable = None
    ...
    def test_custom_logits_processor(self):
        ...
        bart_model = self.parallelize_model(
            model_cls.from_pretrained("hf-internal-testing/tiny-random-bart", min_length=1),
        )
    ...
    @skip_unsupported("VisionEncoderDecoderModel")
    def test_generate_pixel_values_as_encoder_kwarg(self):
        ...
        model = self.parallelize_model(
            model_cls.from_pretrained("hf-internal-testing/tiny-random-VisionEncoderDecoderModel-vit-gpt2")
        )
